 ...
 *
 * Disassembly of DSDT.aml, Sun May 17 17:40:01 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0002142E (136238)
 *     Revision         0x02
 *     Checksum         0x6C
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS4, One)
    // One
    OperationRegion (GNVS, SystemMemory, 0x4FF4F000, 0x072C)
    ...
    IRQNoFlags() { 0, 8, 11, 15 }
        ...
        Device (MOU)
        {
            ...
            Method (MHID, 0, NotSerialized)
            {
                ...
                {
                    Store (0x7200AE30, _HID)
                }
                Else
                {
                    Store (0x7300AE30, _HID)
                }
            }
        }
    }
...
D8XH (0x01, 0xAB)
    ...
    OperationRegion (MNVS, SystemMemory, 0x4FF60018, 0x1000)
    ...
    Scope (\_SB)
    {
        ...
        Device (WMI5)
        {
            ...
            {
                /* 0000 */  0x5E, 0xBD, 0xD0, 0x74, 0x8A, 0x6E, 0x09, 0x48,
                /* 0008 */  0xA7, 0x3A, 0xC1, 0x48, 0xD0, 0x8E, 0xEE, 0xBE,
                /* 0010 */  0x41, 0x45, 0x01, 0x02, 0x21, 0x12, 0x90, 0x05,
                /* 0018 */  0x66, 0xD5, 0xD1, 0x11, 0xB2, 0xF0, 0x00, 0xA0,
                /* 0020 */  0xC9, 0x06, 0x29, 0x10, 0x42, 0x45, 0x01, 0x00 
            })
            ...
            Name (WQBE, Buffer (0x0315)
            {
                ...
                /* 0010 */  0x44, 0x53, 0x00, 0x01, 0x1A, 0x7D, 0xDA, 0x54,
                /* 0018 */  0xA8, 0xDC, 0x83, 0x00, 0x01, 0x06, 0x18, 0x42,
                ...
                /* 00A0 */  0x07, 0xA1, 0x21, 0xB0, 0x11, 0x70, 0xE5, 0x1A,
                /* 00A8 */  0x40, 0x58, 0x88, 0x75, 0x2A, 0x8A, 0x03, 0x18,
                /* 00B0 */  0xCC, 0xA6, 0x25, 0x40, 0xCE, 0x58, 0x51, 0xC0,
                /* 00B8 */  0xF6, 0x3A, 0x11, 0x99, 0x1C, 0x28, 0x95, 0x04,
                /* 00C0 */  0x87, 0x1A, 0xA6, 0x25, 0xCE, 0x4E, 0x23, 0x3B,
                /* 00C8 */  0x91, 0x63, 0x6B, 0x7A, 0xC8, 0x82, 0x64, 0xD2,
                /* 00D0 */  0x86, 0x82, 0x1A, 0xBB, 0xA7, 0x75, 0x52, 0x9E,
                /* 00D8 */  0x69, 0xC4, 0x83, 0x32, 0x4C, 0x02, 0x8F, 0x82,
                /* 00E0 */  0xA1, 0x71, 0x82, 0xB2, 0x20, 0xB4, 0x23, 0x3A,
                /* 00E8 */  0x50, 0x02, 0x78, 0x12, 0x9E, 0x63, 0xF1, 0x02,
                /* 00F0 */  0x84, 0xCF, 0x98, 0x4C, 0x3B, 0x46, 0x02, 0x9F,
                /* 00F8 */  0x09, 0x3C, 0x9A, 0x63, 0xC6, 0x02, 0x85, 0x0B,
                /* 0100 */  0x78, 0x3E, 0xC7, 0x10, 0x39, 0xEE, 0xA1, 0xC6,
                /* 0108 */  0x38, 0x8A, 0xC8, 0x09, 0x4A, 0x1D, 0x88, 0x04,
                /* 0110 */  0x09, 0xD0, 0x38, 0x06, 0x61, 0xB4, 0x8A, 0xA6,
                /* 0118 */  0xF9, 0x1C, 0xDA, 0x83, 0x80, 0x09, 0xFC, 0xFF,
                /* 0120 */  0x17, 0x3D, 0x02, 0x94, 0x0C, 0x08, 0x79, 0x44,
                /* 0128 */  0xD4, 0xA0, 0x4E, 0xC3, 0x04, 0xBD, 0x4D, 0x50,
                /* 0130 */  0x28, 0xAF, 0x0B, 0x15, 0x62, 0xC8, 0xDA, 0x88,
                /* 0138 */  0x64, 0x4B, 0x80, 0x36, 0x0C, 0x89, 0x3B, 0x08,
                /* 0140 */  0x08, 0x25, 0x5A, 0x90, 0x68, 0xCD, 0xA1, 0x08,
                /* 0148 */  0x27, 0x68, 0x67, 0x50, 0xE4, 0x36, 0xD0, 0x18,
                /* 0150 */  0x18, 0x81, 0x36, 0x46, 0xD4, 0x08, 0x86, 0x7F,
                /* 0158 */  0x25, 0xF0, 0x98, 0xB1, 0x83, 0xF7, 0x69, 0xE1,
                /* 0160 */  0xB8, 0x4E, 0xED, 0x90, 0x1E, 0x14, 0x4C, 0xE0,
                /* 0168 */  0x19, 0xBF, 0x1E, 0x3C, 0x1A, 0x04, 0x3F, 0xD4,
                /* 0170 */  0xA8, 0x87, 0xE1, 0x41, 0x91, 0x07, 0x84, 0x2C,
                /* 0178 */  0x80, 0x28, 0x12, 0x3C, 0xEA, 0xB0, 0xE0, 0x63,
                /* 0180 */  0x81, 0x47, 0x76, 0xCC, 0x9E, 0xE1, 0x09, 0x04,
                /* 0188 */  0x39, 0x84, 0x23, 0x78, 0x60, 0x78, 0x1E, 0xF0,
                /* 0190 */  0x18, 0xD8, 0x45, 0xC1, 0x27, 0x00, 0x1F, 0x10,
                /* 0198 */  0xF0, 0xAE, 0x01, 0x75, 0x33, 0x78, 0x2E, 0x60,
                /* 01A0 */  0x53, 0x0E, 0x87, 0x19, 0xAE, 0x47, 0x1F, 0xEE,
                /* 01A8 */  0x04, 0x4E, 0xFB, 0x01, 0x83, 0x1F, 0x36, 0x3C,
                /* 01B0 */  0x38, 0xDC, 0x38, 0x4F, 0xE6, 0xC8, 0x5E, 0x01,
                /* 01B8 */  0x9A, 0x3D, 0x03, 0x68, 0x92, 0x3E, 0x6D, 0xB0,
                /* 01C0 */  0x8B, 0xC0, 0xF9, 0xF4, 0x0C, 0x49, 0xE4, 0x0F,
                /* 01C8 */  0x02, 0x35, 0x32, 0x43, 0x7B, 0xD4, 0x2F, 0x1D,
                /* 01D0 */  0x86, 0x7C, 0x4C, 0x38, 0x2C, 0x26, 0xF6, 0xD4,
                /* 01D8 */  0x41, 0xC7, 0x03, 0xFE, 0xCB, 0xC8, 0x63, 0x86,
                /* 01E0 */  0xA7, 0xEF, 0xF9, 0x9A, 0xA0, 0xC0, 0x93, 0x08,
                /* 01E8 */  0x08, 0xC7, 0xF0, 0xC6, 0xF0, 0xD0, 0xD0, 0xFB,
                /* 01F0 */  0x59, 0x41, 0xFF, 0x7F, 0x90, 0xA7, 0x10, 0x60,
                /* 01F8 */  0x02, 0x75, 0x08, 0x98, 0xF3, 0x80, 0x87, 0xC0,
                /* 0200 */  0x07, 0x70, 0x28, 0xA7, 0x67, 0xA5, 0x93, 0x42,
                /* 0208 */  0x1E, 0x57, 0xC0, 0x96, 0x72, 0xF9, 0x3A, 0x6D,
                /* 0210 */  0x38, 0x21, 0x88, 0x6C, 0x3C, 0x00, 0x3C, 0x56,
                /* 0218 */  0xAA, 0x02, 0x48, 0x73, 0xC4, 0x12, 0x4C, 0x4F,
                /* 0220 */  0xAA, 0x33, 0x0E, 0xCF, 0x4D, 0xA2, 0xE4, 0x63,
                /* 0228 */  0xA2, 0x70, 0xCE, 0x7A, 0xFE, 0xA0, 0x20, 0x06,
                /* 0230 */  0x74, 0x10, 0x08, 0x39, 0x39, 0x1E, 0xA0, 0x8E,
                /* 0238 */  0x26, 0x9E, 0xC1, 0x59, 0x3E, 0xE4, 0x78, 0x40,
                /* 0240 */  0x1E, 0x94, 0xAF, 0x26, 0x3E, 0x7A, 0xF8, 0x14,
                /* 0248 */  0xE1, 0x81, 0xFB, 0x7C, 0xC0, 0xBF, 0x2F, 0xBE,
                /* 0250 */  0x30, 0x18, 0xDD, 0x6A, 0x8E, 0x27, 0x28, 0x30,
                /* 0258 */  0x9F, 0x40, 0x38, 0x41, 0x5D, 0x77, 0x04, 0xE8,
                /* 0260 */  0x07, 0x80, 0x23, 0xF0, 0x50, 0x9E, 0x40, 0x2A,
                /* 0268 */  0xC3, 0x91, 0xBE, 0x33, 0x02, 0x28, 0x80, 0x7C,
                /* 0270 */  0x29, 0xF0, 0x21, 0xE0, 0xC1, 0x80, 0x8D, 0xE1,
                /* 0278 */  0x39, 0xC0, 0x68, 0x46, 0xE7, 0xE1, 0x27, 0x8B,
                /* 0280 */  0x8A, 0x3B, 0x59, 0x0A, 0xE2, 0xC9, 0x3A, 0xCA,
                /* 0288 */  0x64, 0x91, 0xFF, 0xFF, 0xAB, 0x05, 0xBB, 0x50,
                /* 0290 */  0x78, 0x42, 0xA7, 0x14, 0xE4, 0x1C, 0x3D, 0x61,
                /* 0298 */  0x5F, 0x40, 0x60, 0x1D, 0x0D, 0x42, 0x3E, 0x14,
                /* 02A0 */  0x78, 0x1A, 0x86, 0xF3, 0x64, 0x39, 0x9C, 0x27,
                /* 02A8 */  0xCB, 0xC7, 0xE2, 0x0B, 0x06, 0xFC, 0xD1, 0x62,
                /* 02B0 */  0x2F, 0x18, 0x60, 0x99, 0x2D, 0x4C, 0x78, 0xCC,
                /* 02B8 */  0xD5, 0xC5, 0xA3, 0xF2, 0x0D, 0xC8, 0xC3, 0xE3,
                /* 02C0 */  0x97, 0x03, 0xCF, 0xE7, 0x19, 0xE1, 0x28, 0x9F,
                /* 02C8 */  0x22, 0x70, 0x18, 0x0F, 0x23, 0x1E, 0xA2, 0x2F,
                /* 02D0 */  0x43, 0xB0, 0x26, 0x72, 0xD2, 0xBE, 0x2D, 0x9C,
                /* 02D8 */  0x6C, 0xD0, 0xF8, 0x61, 0x7D, 0x19, 0x02, 0x1E,
                /* 02E0 */  0x0A, 0x6D, 0xFA, 0xD4, 0x68, 0xD4, 0xAA, 0x41,
                /* 02E8 */  0x99, 0x1A, 0x65, 0x1A, 0xD4, 0xEA, 0x53, 0xA9,
                /* 02F0 */  0x31, 0x63, 0x57, 0x29, 0x8B, 0xBB, 0x5C, 0x50,
                /* 02F8 */  0x31, 0x4B, 0xD2, 0x98, 0x7C, 0xA5, 0x32, 0x88,
                /* 0300 */  0x45, 0xFE, 0x77, 0x64, 0xE4, 0xB2, 0x62, 0x10,
                /* 0308 */  0x01, 0x59, 0xDD, 0x37, 0x42, 0x40, 0xD6, 0x0A,
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            Fatal (0x01, 0x80010000, 0x000111E5)
        }
